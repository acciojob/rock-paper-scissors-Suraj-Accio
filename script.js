...
function userChoose(e) {
  ...
  if (
    (choices[computerChoose] == "ROCK" && choices[userChoose] == "PAPER") ||
    ...
    (choices[computerChoose] == "PAPER" && choices[userChoose] == "ROCK") ||
  ...
  if (roundsLeft == 0) {
    ...
    gameResultEl.innerText = `${
      outcomes[
        userPoints == computerPoints ? 1 : userPoints > computerPoints ? 0 : 2
      ]
    }`;
